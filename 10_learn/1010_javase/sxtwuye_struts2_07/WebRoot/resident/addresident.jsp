...
<html>
  ...
  $(function(){
				...
				$.ajax({
					type:'post',
				//	url:'${pageContext.request.contextPath }/selectRoom!findAllBuild.sxt',
				 	url:'${pageContext.request.contextPath }/selectRoom!findAllBuildResponse.sxt',
					dataType:'json',
					success:function(rs){
						var b = $("#buildid");
						//alert(rs);
...
//						alert(bid);
						...
						$.ajax({
							type:'post',
							url:"${pageContext.request.contextPath }/selectRoom!findUnitByBuild.sxt",
							data:'bid='+bid,
							dataType:'json',
							success:function(rs){
							//alert(rs);
...
//						alert(bid);
						...
						$.ajax({
							type:'post',
							url:"${pageContext.request.contextPath }/selectRoom!findRoomByUnitId.sxt",
							data:'uid='+uid,
							dataType:'json',
							success:function(rs){
							//alert(rs);
...
<form action="${pageContext.request.contextPath }/resident!addRsd.sxt" method="post" enctype="multipart/form-data"  name="rsdform" onsubmit="return checkRsdForm(this)" >
