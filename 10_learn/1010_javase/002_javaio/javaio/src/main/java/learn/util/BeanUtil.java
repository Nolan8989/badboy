...
public final class BeanUtil {
	...
	@Deprecated
	public static <T> T obj2Repeat(T t) throws BeanUtilException {
		Map<String, Object> map = obj2MapObj(t);
//		Set<String> keySet =  map.keySet();
		Map<String, Object> map2Obj = new HashMap<String, Object>();
...
//				map.remove(entry.getKey());
			...
			String str = StringUtil.value2Repeat(value);
			map2Obj.put(entry.getKey(), str);
		}
		
		return (T) toDTO(map2Obj, t.getClass());
	}
