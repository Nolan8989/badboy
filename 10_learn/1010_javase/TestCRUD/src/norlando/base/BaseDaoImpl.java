...
//System.out.println(methodName);
			...
			String methodId   = "get" + Character.toUpperCase(fs[0].getName().charAt(0))+fs[0].getName().substring(1);
			Method getId = clazz.getDeclaredMethod(methodId);
